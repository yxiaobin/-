...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset("/Font-Awesome/css/font-awesome.css")}}" />    <!--[if IE 6]>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a href="{{url("questionlist")}}" title="资讯管理">问卷列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    @php
                        $userId = session("id");
                    @endphp
                    <li><a href="{{url("info/$userId")}}" title="图片管理">信息修改</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            <dt><i class="Hui-iconfont">&#xe620;</i> 模板广场<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a href="{{url("modalpublic")}}" title="模板列表">模板广场</a></li>

                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
            <dt><i class="Hui-iconfont">&#xe622;</i> 问卷广场<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a href="{{url("search_global_question")}}" title="意见反馈">问卷列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-tongji">
