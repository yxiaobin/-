...
<div class="header_wrap">
    ...
    <div class="edit-header">
        ...
        <div class="edit-center" p-type="None">
            ...
            <a  href="#">
                <div class="edit-center-title">
                    <div id="edit-header-publish" class="showUnderLine">问卷广场</div>
                </div>
            </a>
            <div class="header-edit-icon arrow-left"></div>
            <a  href="#">
    ...
    <div class="survey_main ">
        <div class="survey_prefix_wrap">
            <div class="survey_title">
                <div class="">
                    <div class="title_content" edit-type="project" contenteditable="true" tabindex="0"><p style="text-align: left;">问卷广场</p>
                    </div>
                </div>
            </div>
                                    ...
                                    <table class=" table">
                                        ...
                                        @if(count($objs)==0)
                                            <tr>
                                                ...
                                                <td>
                                                    <span>问卷广场目前还没有任何的问卷可以进行答题</span>
                                                </td>
                                        ...
                                        @foreach($objs as $obj)
                                            <tr>
                                                ...
                                                <td>
                                                    <a>  <span onclick="showLink(this)" name = "{{$obj->link}}">查看详情</span> </a>
                                                ...
                                                <td>
                                                    <a href="{{url("/answer_question/$obj->link")}}" @if($obj->status==0 || $obj->status==-1)  disabled onclick="return false" @endif target="view_window" class="btn btn-success btn-xs" role="button">
                                                        答题
                                                    </a>
