...
<div class = "wholl">
    ...
    <form action="{{url("answer_question")}}" method="post">
        ...
        <div class = "center">
            ...
            @endforeach
            <div class = "next">
                <button type="submit" onclick="return false;" style="width: 80px;height: 50px;background-color: #00BFFF;border-radius: 12px;color: white;font-size: 17px;">提交</button></a>
            </div>
        </div>
    </form>
